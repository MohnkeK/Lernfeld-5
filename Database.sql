...
ALTER TABLE ALLERGENE ADD PRIMARY KEY (ALLERGENEID);
...
ALTER TABLE ZUTATEN ADD FOREIGN KEY (ENKATEGORIE) REFERENCES ENKATEGORIE(ID);
ALTER TABLE ZUTATEN ADD FOREIGN KEY (ALLERGENE) REFERENCES ALLERGENE (ID);
