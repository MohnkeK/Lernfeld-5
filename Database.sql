...
ALTER TABLE ENKATEGORIE ADD PRIMARY KEY (EAID);
ALTER TABLE ALLERGENE ADD PRIMARY KEY (ALLERGENID); ***/
...
/**ALTER TABLE LIEFERANT ADD FOREIGN KEY (PLZ) REFERENCES PLZ(PLZ);
ALTER TABLE ZUTAT ADD FOREIGN KEY (ENKATEGORIE) REFERENCES ENKATEGORIE(EAID);
ALTER TABLE ZUTAT ADD FOREIGN KEY (ALLERGENE) REFERENCES ALLERGENE (ID);**/
